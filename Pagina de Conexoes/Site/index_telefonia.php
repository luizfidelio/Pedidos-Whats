...
<html id="fundogeral">
    <head>
        ...
        <script>
            // Função para clicar automaticamente no link
            function clicarNoLink() {
            var link = document.getElementById('modal-video');
            link.click();
            }

            // Chame a função de clique assim que a página for carregada
            document.addEventListener('DOMContentLoaded', clicarNoLink);
        </script>
    ...
    <body id="" class="">
        ...
        <div id="popup">
            <div id="link-oculto">
                <p id="" uk-margin>
                    <a id="modal-video" class="uk-button uk-button-default" href="#modal-media-youtube" uk-toggle>YouTube</a>
                </p>
            </div>
            <div id="modal-media-youtube" class="uk-flex-top" uk-modal>
                <div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
                    <button class="uk-modal-close-outside" type="button" uk-close></button>
                    <iframe src="https://www.youtube-nocookie.com/embed/UWM9HxOxdGk" width="800" height="600" uk-video="automute: true" uk-responsive ></iframe>
                </div>
            </div>
        </div>   
            ...
            <div class="uk-container" style="padding: 0px;">
                <div id="img-mob" class="uk-text-center uk-grid-collapse" uk-grid>
                    ...
                    <div id="img-mob0" class="uk-width-1-1@m">
                        <div id="menu-mob" class="uk-card uk-card-default uk-card-body"><h2 id="h2-img-mob0">Soluções em tecnologia para auxiliar a sua empresa.</h2></div>
                    </div>
                    <div id="img-mob1" class="uk-width-1-1@m">
                        <a href="automacao.php" class="uk-link-toggle"><div id="menu-mob" class="uk-card uk-card-default uk-card-body"><p id="p-img-mob1">Automação Comercial</p></div></a>	
                    </div>
                    <div id="img-mob2" class="uk-width-1-1@m">
                        <a href="telefonia.php" class="uk-link-toggle"><div id="menu-mob" class="uk-card uk-card-default uk-card-body"><p id="p-img-mob2">Telefonia em Nuvem</p></div></a>
                    </div>
                    <div id="img-mob3" class="uk-width-1-1@m">
                        <!--<a href="" class="uk-link-toggle">--><div id="menu-mob" class="uk-card uk-card-default uk-card-body"><p id="p-img-mob3">Servidores</p></div><!--</a> remover este comentario ao colocar o link-->	
                    </div>
                    <div id="img-mob4" class="uk-width-1-1@m">
                        <!--<a href="" class="uk-link-toggle">--><div id="menu-mob" class="uk-card uk-card-default uk-card-body"><p id="p-img-mob4">Redes</p></div><!--</a> remover este comentario ao colocar o link-->	
                    </div>
